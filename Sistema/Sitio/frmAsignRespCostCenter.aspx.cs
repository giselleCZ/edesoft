...
namespace Sitio
{
    public partial class frmAsignRespCostCenter : System.Web.UI.Page
    {
        ...
        public void LoadResponsibles()
        {
            ...
            grdRespCostCenter.DataSource = obj;
            grdRespCostCenter.DataBind();
        }
        public void loadRoles()
        {
            List<clsRol> objRol = CRol.SelectAll();
            ddlResponsible.DataSource = objRol;
            ddlResponsible.DataTextField = "SRol_name";
            ddlResponsible.DataValueField = "IRol_id";
        ...
        public void loadRol(int iRol_id)
        {
            ...
            ddlResponsible.DataTextField = "SRol_name";
            ddlResponsible.DataValueField = "IRol_id";
            SetDDLs(ddlResponsible, getRol(iRol_id));
        ...
        protected void btnGuardarRespCostCenter_Click(object sender, EventArgs e)
        {
